...
describe('Shape', () => {
    describe('The constructor for Shape', () => {
        ...
        it('should reject text inputs that have special characters', () => {
            const text = 'H&M';
            const color = 'aquamarine';
            const textColor = 'red';
            expect(() => new Shape(text, textColor, color)).toThrow('text must not contain any special characters');
        })
    ...
    describe('The setter functions', () => {
        const shape = new Shape('edX', '#888', '#22F');
        it('should reject text inputs that are not strings', () => {
            const text = 0;
            expect(() => shape.text=text).toThrow('text must be a string');
        })
        it('should reject text inputs that contain special characters', () => {
            const text = '&*)';
            expect(() => shape.text=text).toThrow('text must not contain any special characters');
        })
